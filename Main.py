...
class hotel:
        ...
        while True:
            try:
                ...
                another_customer = input(
                    "Do You Want to Add Details Of Another Customer(Yes/No) --> "
                ).lower()
    ...
    def add_booking_info(self):
        ...
        while True:
            try:
                ...
                customer_exists = any(
                    info["Name"].lower() == name.lower() for info in self.customer_info
                )
                if not customer_exists:
                    print(
                        "Customer details not found. Please add customer details first."
                    )
                    break
                ...
                print(
                    f"The Booking Details For Name: {name} Saved In The Hotel Records!"
                )
    ...
    def remove_customer_info(self):
        ...
        while True:
            try:
                num = int(
                    input("Enter The Number Of Customer Details You want to Remove -->")
                )
                if num > len(self.customer_info):
                    raise ValueError(
                        f"Invalid Number Of Query: There Are only {len(self.customer_info)} Customer Details Present in the Hotel Record!"
                    )
                for _ in range(num):
                    name = input(
                        "Please Enter The Name Of The Customer To remove Details --> "
                    )
                    for info in self.customer_info:
                        if info["name"].lower() == name.lower():
                            ...
                            self.save_customer_info()
                            print(
                                f"The Customer Details Of the Person {name} is Deleted From The Hotel Records!"
                            )
                            break
            except ValueError as e:
                print(e)
    ...
    def remove_booking_info(self):
        ...
        while True:
            try:
                name = input(
                    "Please Enter The Name Of The Customer To Remove Booking --> "
                )
                found = False
                for info in self.booking_info:
                    if info["Name"].lower() == name.lower():
                        ...
                        self.save_booking_info()
                        print(
                            f"The Booking Details Of the Person {name} is Deleted From The Hotel Records!"
                        )
                        found = True
                        break
                if not found:
    ...
    def show_booking_info(self):
        ...
        if self.booking_info:
            print(
                "| Name | Check-in Date | Check-out Date | Room Type | Number of Guests | Special Requests | Payment Method | ID Type | ID Number |"
            )
            for info in self.booking_info:
                print(
                    f'| {info["Name"]} | {info["Check-in Date"]} | {info["Check-out Date"]} | {info["Room Type"]} | {info["Number of Guests"]} | {info["Special Requests"]} | {info["Payment Method"]} | {info["ID Type"]} | {info["ID Number"]} |'
                )
        else:
    ...
    def show_booking_for_customer(self):
        ...
        """
        name = input(
            "Please Enter The Name Of The Customer To Show Booking Details --> "
        )
        found = False
        for info in self.booking_info:
            if info["Name"].lower() == name.lower():
    ...
    def show_customer_info(self):
        ...
        if self.customer_info:
            ...
            for info in self.customer_info:
                print(
                    f'| {info["Name"]} | {info["Phone"]} | {info["Email"]} | {info["Address"]} |'
                )
        else:
...
def main():
    while True:
        print(
            "__________________Welcome To The Hotel Management System__________________"
        )
